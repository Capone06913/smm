...
> **FlowPilot (SMM бренд и сайт):** [`FLOWPILOT.md`](./FLOWPILOT.md) → [`docs/brand/brand-core.md`](./docs/brand/brand-core.md) → прототип [`prototype.html`](./prototype.html) → legal [`legal/index.html`](./legal/index.html).
